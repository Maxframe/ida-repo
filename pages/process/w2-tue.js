  ...
  return (
    <>
      ...
      <div className=" w-[700px] m-auto text-justify py-12">
        ...
        <a className="pt-4 block underline" href="https://www.designbiennalezurich.ch/2019/noumenon" target="_blank" rel="noreferrer">Austellung Biennale Zürich 2019</a>
        <a className="block underline" href="https://noumenon.lauragyr.ch/index.html" target="_blank" rel="noreferrer">Link zum Noumenon Creator</a>
